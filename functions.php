...
function university_features()
{
    ...
    add_image_size( 'professorPortrait', 450, 460, true );
    add_image_size( 'pageBanner', 1500, 350, true );


    // register_nav_menu('headerMenuLocation', 'Header Menu Location');
    // register_nav_menu('footerLocatiomOne', 'Footer Location One');
    // register_nav_menu('footerLocatiomTwo', 'Footer Location Two');
