...
class MyNotes {
  ...
  async deleteNote(e) {
    ...
    try {
      const response = await axios.delete(universityData.root_url + "/wp-json/wp/v2/notes/" + thisNote.getAttribute("data-id"))
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios.post(universityData.root_url + "/wp-json/wp/v2/notes/" + thisNote.getAttribute("data-id"), ourUpdatedPost)
      this.makeNoteReadOnly(thisNote)
    } catch (e) {
      console.log("Sorry")
    }
  ...
  async createNote() {
    ...
    try {
      const response = await axios.post(universityData.root_url + "/wp-json/wp/v2/notes/", ourNewPost)
